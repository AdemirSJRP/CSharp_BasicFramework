/* ----------------------------------------------------------------------------------------------------------------------------
* Classe clsEpson.cs - Data desconhecida entre 2011 e 2012 (versão antiga de 12/06/2008)
* Desenvolvida por: Fabricante do ECF Epson
...
namespace DllFiscal
{
    public class clsInterfaceEpson
    {
        //=================================================================================================;
        // EPSON_Serial
        //=================================================================================================;
